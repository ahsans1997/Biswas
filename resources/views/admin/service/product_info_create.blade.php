        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Create New Service Product Information</li>
                </ol>
            </nav>
        </div>
        <div class="col-md-11 m-auto">

            <form method="POST" action="{{ route('service.product.store') }}">
                @csrf
                <div class="form-group">
                    ...
                    @enderror
                    <input type="text" name="service_product_title" class="form-control" placeholder="Product Information Title">
                </div>
                <div class="form-group">
                    ...
                    @error('service_product_percent')
                        <div class="alert alert-danger mb-2">{{ $message }}</div>
                    @enderror
                    <input class="form-control" type="number" placeholder="0" name="service_product_percent">
                    <input type="hidden" name="service_id" value="{{ $service_product_info->id }}">
                </div>
