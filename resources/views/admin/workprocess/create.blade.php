        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Create Latest Work</li>
                </ol>
            </nav>
        </div>
        <div class="col-md-11 m-auto">

            <form method="POST" action="{{ route('work-process.store') }}">
                @csrf
                <div class="form-group">
                    ...
                    @enderror
                    <input type="text" name="name" class="form-control" placeholder="Work Title">
                </div>
