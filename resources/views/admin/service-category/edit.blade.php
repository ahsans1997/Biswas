...
<div class="content-wrapper">
    <div class="row">
        ...
        <div class="col-md-11 m-auto">
            ...
            <form method="POST" action="{{ route('service-category.update', $service_category_info->id) }}">
                @csrf
                @method('PATCH')
                <div class="form-group">
                    ...
                    @enderror
                    <input type="text" name="service_category_name" value="{{ $service_category_info->service_category_name	 }}" class="form-control" placeholder="Service Category Name">
                </div>
