...
<head>
    ...
    <title>Trax | Particles-Index</title>
    ...
    <nav class="navbar navbar-expand-lg padding-nav static-nav">
        <div class="container">
            <a class="navbar-brand" href="index.html">
                <img src="images/biswas.png" alt="logo">
            </a>
                ...
                <div class="news_item shadow">
                    ...
                    <div class="news_desc text-center text-md-start">
                        ...
                        <div class="profile-authors heading_space">
                            ...
                            <div class="eny_profile text-start">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer_panel padding_bottom_half bottom20">
                    <a href="index.html" class="footer_logo bottom25"><img src="images/biswas.png" alt="trax"></a>
